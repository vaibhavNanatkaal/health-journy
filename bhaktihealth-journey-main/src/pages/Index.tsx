  ...
  const features = [
    {
      ...
      description:
        "Holistic approach to achieving and maintaining long-term health transformations.",
      icon: Scale,
    },
    {
      title: "Whole-body Wellness",
      description:
        "Comprehensive strategies for physical, mental, and emotional health integration.",
      icon: Heart,
    },
    {
      title: "Coaching, Your Way",
      description:
        "Personalized strategies tailored to your unique health journey and goals. NBC-HWC & AFPA Approved.",
      icon: Calendar,
    },
    {
      title: "Certified Expertise",
      description:
        "Work with highly trained health professionals with NBC-HWC & AFPA Approved specialized knowledge.",
      icon: User,
    },
  ];
  const approaches = [
    {
      ...
      description:
        "We start with a comprehensive evaluation of your health history, lifestyle, and goals.",
      icon: Zap,
    },
    {
      title: "Custom Plan Creation",
      description:
        "Your coach develops a tailored wellness plan addressing your specific needs.",
      icon: Calendar,
    },
    {
      title: "Regular Check-ins",
      description:
        "Consistent sessions to track progress, make adjustments, and ensure accountability.",
      icon: Clock,
    },
    {
      title: "Community Support",
      description:
        "Access to group sessions and community resources to enhance your journey.",
      icon: UserPlus,
    },
  ];
  const testimonials = [
    {
      quote:
        "BhaktiHealth helped me achieve what felt impossible. My diabetes is now under control, and I've lost 30 pounds through their personalized approach.",
      name: "Sophia Rodriguez",
      title: "Type 2 Diabetes Patient",
      avatar:
        "https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?w=100&h=100&fit=crop&crop=faces&auto=format",
      bgColor: "bg-white",
    },
    {
      quote:
        "The stress management techniques my coach taught me have transformed my life. My blood pressure is lower than it's been in 10 years.",
      name: "Michael Chen",
    ...
    {
      quote:
        "As a teenager struggling with weight, I finally found a program that doesn't shame me but empowers me. I've gained confidence and healthy habits.",
    ...
    {
      quote:
        "The postpartum program was exactly what I needed. They understood my challenges and helped me regain my strength and balance.",
      name: "Jessica Taylor",
  ...
  return (
    <PageTransition>
      <div className="relative">
        ...
        <section className="py-20 bg-white" id="features">
          <div className="container mx-auto px-6 md:px-12">
            ...
            >
              ...
              >
                Our comprehensive approach addresses the unique challenges of
                diabetes, hypertension, obesity, and postpartum recovery through
                expert coaching and customized plans.
              </motion.p>
            </div>
        ...
        <section
          id="about"
          className="py-20 bg-gradient-to-br from-white to-bhakti-50"
          id="approach"
        >
          <div className="container mx-auto px-6 md:px-12">
            <div
              ref={approachRef.ref as React.RefObject<HTMLDivElement>}
            ...
            >
              ...
              >
                <div className="relative z-10 rounded-2xl overflow-hidden shadow-xl">
                  <img
                    ...
                    loading="lazy"
                    src="/lovable-uploads/4ee5a828-eda1-41a4-abb3-e46eaef7b3d9.jpg"
                  />
                </div>
              ...
              <div className="lg:w-1/2">
                ...
                >
                  How Bhakti Health and Wellness Transforms Your Lifestyle
                </motion.h2>
                ...
                >
                  Our proven four-step approach ensures that every client
                  receives personalized care and achievable health goals,
          ...
          <div className="container mx-auto px-6 md:px-12">
            ...
            >
              ...
              <motion.p
                ...
                className="text-lg text-gray-600"
              >
                Hear from clients who have transformed their health with our
        ...
        <section
          id="plans"
          ref={planRef.ref as React.RefObject<HTMLDivElement>}
          className="py-20 bg-gradient-to-br from-white to-bhakti-50"
        >
          <div className="container mx-auto px-6 md:px-12">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <motion.p
                ...
                className="text-lg text-gray-600 mb-8"
              >
                We offer flexible options for individuals, groups, and corporate
                clients.
              </motion.p>
            </div>
              ...
              <div className="px-6 py-12 md:px-12 md:py-16 relative z-10">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto">
                    Our certified coaches are ready to help you achieve your
                    health goals with personalized plans that fit your unique
                    needs.
                  </p>
                  ...
                  <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
                    <Link
                      to="/contact"
                      className="px-6 py-3 rounded-lg bg-white text-bhakti-700 font-medium hover:bg-gray-100 transition-colors duration-200 shadow-lg"
                    >
                      Schedule a Free Consultation
                    </Link>
                    <Link
                      to="/#plans"
                      className="px-6 py-3 rounded-lg bg-transparent border border-white/40 text-white font-medium hover:bg-white/10 transition-colors duration-200"
                    >
                      View Pricing Plans
                    </Link>
                  </div>
